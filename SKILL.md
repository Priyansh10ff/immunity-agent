...
After install, **verify** by re-running `immunity status` — `Hooks:` should now list the agent you just installed.
...
**Secret usage** — flow is one-time registration, then placeholder forever:
